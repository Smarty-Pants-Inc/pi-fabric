...
import type { AgentServiceAction, AgentServiceCapabilities, AgentServiceRequest } from "./service-types.js";

const native = (name: string): FabricActionDescriptor => {
