...
export class MeshStore {
  ...
  /**
   * Takes and releases the mesh lock without reading or writing the state: evidence that the
   * shared state is writable now, for a heartbeat that renewed only its file lease.
   */
